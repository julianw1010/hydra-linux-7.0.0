					 ...
					 int cache_level)
{
	...
	new_page = hydra_cache_pop(target_node, cache_level);
	if (new_page) {
			      ...
			      int target_node)
{
	...
	new_page = migrate_pgtable_page(old_page, target_node, HYDRA_CACHE_PTE);
	if (!new_page)
		return;
			      ...
			      int target_node)
{
	...
	new_page = migrate_pgtable_page(old_page, target_node, HYDRA_CACHE_PMD);
	if (!new_page)
		return;
			      ...
			      int target_node)
{
	...
	new_page = migrate_pgtable_page(old_page, target_node, HYDRA_CACHE_PUD);
	if (!new_page)
		return;
			      ...
			      int target_node)
{
	...
	new_page = migrate_pgtable_page(old_page, target_node, HYDRA_CACHE_P4D);
	if (!new_page)
		return;
